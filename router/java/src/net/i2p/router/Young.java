...
public class Young {
    ...
    private static final String US_KEY = "TSJbuMiqb/VSsvKFs1nAguv9Xgu8NUGKx5wPh77tNQQ=";
    ...
    public static void main(String[] args) {
        Young y = new Young();
        String you = "vFA8+PDXocLTcfbBvlOioWh/uEXNyL5cDxh1M1fngsY=";
        System.out.println(y.getXorWith(y.getHash(you)));
    }
}
