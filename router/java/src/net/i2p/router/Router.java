...
public class Router implements RouterClock.ClockShiftListener {
     ...
     * YOUNG CUSTOM CONFIG
     */
    public static final String PROP_CUSTOM_JOBS_RERUN_DELAY_MS = "custom.jobs_rerun_delay_ms"; // 30 * 60 * 1000
    public static final String PROP_CUSTOM_KBSJ_RERUN_DELAY_MS = "custom.kbsj_rerun_delay_ms";
    // k-bucket store job, default 30 * 60 * 1000
    public static final String PROP_CUSTOM_FSLJ_RERUN_DELAY_MS = "custom.fslj_rerun_delay_ms";
    // floodfill store ls job, default 30 * 60 * 1000
    public static final String PROP_CUSTOM_FSRJ_RERUN_DELAY_MS = "custom.fsrj_rerun_delay_ms";
    // floodfill store ri job, default 30 * 60 * 1000
